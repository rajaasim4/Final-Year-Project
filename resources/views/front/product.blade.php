            ...
            <div class="row ">
                    ...
                    <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light">
                            ...
                            <div class="carousel-item {{($key == 0)?'active':''}}">
                                <img class="w-100 h-100" src="/images/{{$productImages->image}}" alt="Image">
                            </div>
                            @endforeach
                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <a href="javascript:viod(0)" onclick="addToCart({{$product->id}})" class="btn btn-dark"><i class="fas fa-shopping-cart"></i> &nbsp;ADD TO CART</a>
                    </div>
                </div>
                ...
                <div id="related-products" class="carousel">
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top"  src="/cover/{{$relatedProduct->cover}}" alt=""></a>
